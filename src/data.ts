...
export const PRODUCTS: Product[] = [
  // --- Original products ---
  {
    name: 'Copper Pipes',
    description:
      'High-quality copper pipes available in various sizes for HVAC and refrigeration.',
    image:
  ...
  },
  {
    name: 'Elbows',
    description:
      'Copper elbows and fittings in multiple sizes for secure pipe connections.',
    image:
  ...
  },
  {
    name: 'Gas Gauges',
    description:
      'Precision gas gauges for accurate refrigerant pressure readings.',
    image:
  ...
  // --- New products ---
  {
    name: 'Refrigerators',
    description:
      'Commercial and domestic fridges for reliable food and beverage cooling.',
    image:
      'https://images.pexels.com/photos/38306635/pexels-photo-38306635.jpeg',
  },
  {
    name: 'Air Conditioners',
    description:
      'Split, window, and industrial AC units for efficient space cooling.',
    image:
      'https://images.pexels.com/photos/27134985/pexels-photo-27134985.jpeg',
  },
  {
    name: 'Control Panels',
    description:
      'HVAC control panels for centralised monitoring and system management.',
    image:
      'https://images.pexels.com/photos/5953723/pexels-photo-5953723.jpeg',
  },
  {
    name: 'Thermostats',
    description:
      'Digital and programmable thermostats for precise temperature control.',
    image:
      'https://images.pexels.com/photos/7616651/pexels-photo-7616651.jpeg',
  },
  {
    name: 'Evaporator Fans',
    description:
      'High-performance evaporator fan motors for consistent air circulation.',
    image:
      'https://images.pexels.com/photos/5502720/pexels-photo-5502720.jpeg',
  },
  {
    name: 'Thermostatic Expansion Valves',
    description:
      'TXV valves for precise refrigerant flow control in HVAC systems.',
    image:
      'https://images.pexels.com/photos/372796/pexels-photo-372796.jpeg',
  },
];
...
export const ABOUT_IMAGE =
  'https://github.com/Kagwi/Kyms-Refrigeration/blob/main/Paul%20Kyms%20Staff.jpeg?raw=true" alt="Paul Kyms" className="w-full h-auto object-contain object-top"';
...
export const PAST_CLIENTS: Client[] = [
  ...
  {
    name: 'Christian Foundation Fellowship',
    type: 'Church',
    icon: Building2,
  },
  {
  ...
  {
    name: 'Scales Technology',
    type: 'Office Space',
    icon: Building2,
  },
  {
    name: 'Highland Peak View Apartments',
    type: 'Residential',
    icon: Building2,
  },
];
...
export const PARTNERS: Partner[] = [
  {
    name: 'Roch',
    logo: '/logos/roch.png',
    tagline: 'HVAC & Refrigeration',
  },
  {
    name: 'Hisense',
    logo: '/logos/hisense.png',
    tagline: 'HVAC & Refrigeration',
  },
  {
    name: 'Von Hot Point',
    logo: '/logos/von-hot-point.png',
  ...
  {
    name: 'SmartPro',
    logo: '/logos/smartpro.png',
    tagline: 'Commercial Cooling',
  },
  {
    name: 'Bitzer Kenya',
    logo: '/logos/bitzer.png',
    tagline: 'Refrigeration Compressors',
  },
  {
    name: 'TCL',
    logo: '/logos/tcl.png',
    tagline: 'Compressor Technology',
  },
  {
    name: 'Danfoss Supply',
    logo: '/logos/danfoss.png',
    tagline: 'Refrigeration Controls',
  },
  {
    name: 'Haier',
    logo: '/logos/haier.png',
    tagline: 'Heat Exchangers',
  },
];
